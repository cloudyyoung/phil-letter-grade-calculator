...
class Course {
    ...
    _display() {
        ...
        this.components.forEach((component) => {
            let componentHtml = `
                <!-- ${component.title} -->
                <div class="column ${component.code} is-half-tablet is-one-third-desktop">
                    ...
                    <div class="columns is-desktop">
                        ...
                        <div class="column is-4-desktop is-full-tablet">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-4-tablet is-full-desktop">
                                    <!- Tentative Grade ->
...
Course.add({
    ...
    rules: [
        ...
        { grade: "C+", total: 26, requirements: { "problem-set": { "complete": 8 }, "quiz": { "complete": 8 }, "challenge-problem": { "complete": 8 } } },
        { grade: "C", total: 24, requirements: { "problem-set": { "complete": 8 }, "quiz": { "complete": 8 }, "challenge-problem": { "complete": 8 } } },
